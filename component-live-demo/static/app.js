...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator__ = __webpack_require__(72);
...
var loader = new __WEBPACK_IMPORTED_MODULE_2__Loader__["a" /* Loader */](document);
var scripts = [];
var styles = [];
...
function getExternalSources() {
    ...
    try {
        for (var _iterator = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator___default()(scripts), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    try {
        for (var _iterator2 = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator___default()(styles), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
function loadExternalSources() {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a.all(getExternalSources()).then(function () {
        console.log('resolve');
...
var Loader = function () {
    ...
    __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(Loader, [{
        key: 'load',
        value: function load(tag, url, resolve, reject) {
            var element = void 0;
            var parent = void 0;
            ...
            if (flag) {
                ...
                element.addEventListener('error', function (message) {
                    reject(url);
                    console.log(message);
                });
        ...
        value: function loadCSS(url) {
            ...
            return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
                return _this.load('style', url, resolve, reject);
            });
        }
    }, {
        key: 'loadJS',
        value: function loadJS(url) {
            ...
            return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
                return _this2.load('script', url, resolve, reject);
            });
        }
    }]);
